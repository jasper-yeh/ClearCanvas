...
namespace ClearCanvas.Dicom
{
    ...
    #region DicomAttributeOL

    /// <summary>
    /// <see cref="DicomAttributeBinary"/> derived class for storing OL value representation tags.
    /// </summary>
    public class DicomAttributeOL : DicomAttributeBinary<int>
    {
        public DicomAttributeOL(uint tag)
            : base(tag) { }

        public DicomAttributeOL(DicomTag tag)
            : base(tag)
        {
            if (!tag.VR.Equals(DicomVr.OLvr)
                && !tag.MultiVR)
                throw new DicomException(SR.InvalidVR);
        }

        internal DicomAttributeOL(DicomTag tag, ByteBuffer item)
            : base(tag, item) { }

        internal DicomAttributeOL(DicomAttributeOL attrib)
            : base(attrib) { }

        internal DicomAttributeOL(DicomTag tag, FileReference reference)
            : base(tag, reference) { }
        ...
        public override DicomAttribute Copy()
        {
            return new DicomAttributeOL(this);
        }
        ...
        protected override bool SetValuesCore(object value)
        {
            ...
            if (values != null)
            {
                Data = new DicomAttributeBinaryData<int>(values);
                return true;
            }
            return false;
        }
    ...
    #region DicomAttributeOV

    /// <summary>
    /// <see cref="DicomAttributeBinary"/> derived class for storing OV value representation tags.
    /// </summary>
    public class DicomAttributeOV : DicomAttributeBinary<long>
    {
        public DicomAttributeOV(uint tag)
            : base(tag) { }

        public DicomAttributeOV(DicomTag tag)
            : base(tag)
        {
            if (!tag.VR.Equals(DicomVr.OVvr)
                && !tag.MultiVR)
                throw new DicomException(SR.InvalidVR);
        }

        internal DicomAttributeOV(DicomTag tag, ByteBuffer item)
            : base(tag, item) { }

        internal DicomAttributeOV(DicomAttributeOV attrib)
            : base(attrib) { }

        internal DicomAttributeOV(DicomTag tag, FileReference reference)
            : base(tag, reference) { }
        ...
        public override DicomAttribute Copy()
        {
            return new DicomAttributeOV(this);
        }
        ...
        protected override bool SetValuesCore(object value)
        {
            var values = value as long[];
            if (values != null)
            {
                Data = new DicomAttributeBinaryData<long>(values);
                return true;
            }
            return false;
        }

        protected override long ParseNumber(string val, CultureInfo culture)
        {
            if (string.IsNullOrEmpty(val))
                throw new DicomDataException("Null values invalid for OV VR");

            long parseVal;
            if (!long.TryParse(val.Trim(), NumberStyle, culture, out parseVal))
                throw new DicomDataException(String.Format("Invalid long format value for tag {0}: {1}", Tag, val));
            return parseVal;
        }

        protected override string FormatNumber(long val, CultureInfo culture)
        {
            return val.ToString(culture);
        }
    ...
    #region DicomAttributeSV

    /// <summary>
    /// <see cref="DicomAttributeBinary"/> derived class for storing SV value representation tags.
    /// </summary>
    public class DicomAttributeSV : DicomAttributeBinary<long>
    {
        #region Constructors

        public DicomAttributeSV(uint tag)
            : base(tag) { }

        public DicomAttributeSV(DicomTag tag)
            : base(tag)
        {
            if (!tag.VR.Equals(DicomVr.SVvr)
                && !tag.MultiVR)
                throw new DicomException(SR.InvalidVR);
        }

        internal DicomAttributeSV(DicomTag tag, ByteBuffer item)
            : base(tag, item) { }

        internal DicomAttributeSV(DicomAttributeSV attrib)
            : base(attrib) { }
        ...
        public override DicomAttribute Copy()
        {
            return new DicomAttributeSV(this);
        }
        ...
        {
            if (string.IsNullOrEmpty(val))
                throw new DicomDataException("Null values invalid for SV VR");
        ...
        public override void AppendUInt64(UInt64 value)
        {
            if (value > (UInt64) long.MaxValue)
                throw new DicomDataException(String.Format("Invalid SV value {0} for tag {1}.", value, Tag));

            AppendValue((long) value);
        }

        /// <summary>
        /// Retrieves an Int16 value from an SV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Retrieves an Int32 value from an SV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Retrieves an Int64 value from an SV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Retrieves an UInt16 value from an SV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Retrieves an UInt32 value from an SV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
        ...
        public override bool TryGetUInt32(int index, out UInt32 value)
        {
            ...
            value = (UInt32) val;
            return val >= 0 && val <= UInt32.MaxValue;
        }

        /// <summary>
        /// Retrieves an UInt64 value from an SV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
    ...
    /// <summary>
    /// <see cref="DicomAttributeBinary"/> derived class for storing UV value representation tags.
    /// </summary>
    public class DicomAttributeUV : DicomAttributeBinary<ulong>
    {
        #region Constructors

        public DicomAttributeUV(uint tag)
            : base(tag) { }

        public DicomAttributeUV(DicomTag tag)
            : base(tag)
        {
            if (!tag.VR.Equals(DicomVr.UVvr)
                && !tag.MultiVR)
                throw new DicomException(SR.InvalidVR);
        }

        internal DicomAttributeUV(DicomTag tag, ByteBuffer item)
            : base(tag, item) { }

        internal DicomAttributeUV(DicomAttributeUV attrib)
            : base(attrib) { }
        ...
        public override DicomAttribute Copy()
        {
            return new DicomAttributeUV(this);
        }
        ...
        protected override ulong ParseNumber(string val, CultureInfo culture)
        {
            if (string.IsNullOrEmpty(val))
                throw new DicomDataException("Null values invalid for UV VR");

            ulong parseVal;
            if (!ulong.TryParse(val.Trim(), NumberStyle, culture, out parseVal))
                throw new DicomDataException(String.Format("Invalid ulong format value for tag {0}: {1}", Tag, val));
            return parseVal;
        }

        protected override string FormatNumber(ulong val, CultureInfo culture)
        {
            return val.ToString(culture);
        }
        ...
        {
            if (value < 0)
                throw new DicomDataException(String.Format("Invalid UV value '{0}' for {1}.", value, Tag));
            AppendValue((ulong) value);
        }
        ...
        public override void SetInt64(int index, Int64 value)
        {
            if (value < 0 || (decimal) value > ulong.MaxValue)
                throw new DicomDataException(String.Format("Invalid UV value '{0}' for {1}.", value, Tag));
            SetValue(index, (ulong) value);
        }
        ...
        /// <summary>
        /// Retrieves an Int16 value from an UV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
        ...
        public override bool TryGetInt16(int index, out Int16 value)
        {
            ...
            value = (Int16) val;
            return val <= (ulong) Int16.MaxValue;
        }

        /// <summary>
        /// Retrieves an Int32 value from an UV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Retrieves an Int64 value from an UV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
        ...
        public override bool TryGetInt64(int index, out Int64 value)
        {
            ...
            value = (Int64) val;
            return val <= Int64.MaxValue;
        }

        /// <summary>
        /// Retrieves an UInt16 value from an UV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Retrieves an UInt32 value from an UV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Retrieves an UInt64 value from an UV attribute.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
